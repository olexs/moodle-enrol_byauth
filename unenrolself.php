...
/**
 * byauth enrolment plugin - support for user byauth unenrolment.
 *
 * @package    enrol
 * @subpackage byauth
...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'byauth'), '*', MUST_EXIST);
...
$message = get_string('unenrolbyauthconfirm', 'enrol_byauth', format_string($course->fullname));
